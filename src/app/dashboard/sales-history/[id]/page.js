      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-1">View or print invoice {invoiceId}</p>
          </div>
        </div>
        
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button 
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-5 py-2.5 rounded-xl font-medium transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-2"
          >
        ...
        <div className="p-8 sm:p-12 border-b border-slate-100 bg-slate-50/50">
          <div className="flex flex-col sm:flex-row justify-between gap-8">
            ...
            <div className="sm:text-right">
              ...
              <h2 className="text-3xl font-bold text-slate-900 mb-2">{invoiceId}</h2>
              <p className="text-slate-500 text-sm">Issue Date: <span className="font-semibold text-slate-700">01 Jul 2025</span></p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-12 border-b border-slate-100">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
              ...
              <p className="font-bold text-slate-900 text-lg mb-1">Rahim Uddin</p>
            ...
            <div className="sm:text-right">
              ...
              <p className="text-slate-500 text-sm">Created by: Admin User</p>
            </div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr>
                  <td className="px-4 py-5 text-slate-500">1</td>
                  <td className="px-4 py-5 font-bold text-slate-900">Logitech Wireless Mouse</td>
                  <td className="px-4 py-5 text-right text-slate-600">৳650.00</td>
                  <td className="px-4 py-5 text-center font-medium text-slate-700">2</td>
                  <td className="px-4 py-5 text-right font-bold text-slate-900">৳1,300.00</td>
                </tr>
                <tr>
                  <td className="px-4 py-5 text-slate-500">2</td>
                  <td className="px-4 py-5 font-bold text-slate-900">HP Mechanical Keyboard</td>
                  <td className="px-4 py-5 text-right text-slate-600">৳650.00</td>
                  <td className="px-4 py-5 text-center font-medium text-slate-700">1</td>
                  <td className="px-4 py-5 text-right font-bold text-slate-900">৳650.00</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="mt-8 flex justify-end">
            <div className="w-full sm:w-1/2 lg:w-1/3 space-y-3">
              <div className="flex justify-between items-center text-sm text-slate-600 px-4">
                <span>Subtotal</span>
                <span className="font-medium text-slate-900">৳1,950.00</span>
              </div>
              <div className="flex justify-between items-center text-sm text-slate-600 px-4">
                <span>Tax (0%)</span>
              ...
              <div className="pt-4 border-t border-slate-200 flex justify-between items-center px-4">
                ...
                <span className="text-2xl font-bold text-indigo-600">৳1,950.00</span>
              </div>
            </div>
          </div>
